...
This chunk introduces the usage of applying the `FCMm` package (and its built-in centrodis) to cluster water spectra. The details of obtaining the centrodis could be found in [Bi *et al.* (2019)][Bi]. Also, run `vignette("Builtin_centrodis")` to see more about this applicaiton.
...
## References
 ...
 - Dembélé D. Multi-objective optimization for clustering 3-way gene expression data[J]. Advances in Data Analysis and Classification, 2008, 2(3): 211-225.
