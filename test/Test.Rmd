...
## Check whether the Rrs is normally distributed.
...
The `Nechad2015` data set shows that the Rrs is skewed data.
...
## Check the `apply_FCM_m` function.
...
Good news! The `apply_FCM_m` returns the same result which from function `FCM.new`.

## Chla estimation and assessment.
